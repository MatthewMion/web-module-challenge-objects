...
function getReviewByIndex(array, numberIndex) {

  return `${array[numberIndex].name} gave the restaurant a ${array[numberIndex].rating} star review, and their feedback was: ${array[numberIndex].feedback}`;
}
